                ...
                <div class="card-login">
                    ...
                    <div class="card-body">
                        <form action="#" method="POST" enctype="multipart/form-data" novalidate>
                            ...
                            <div class="form-group row">
                                <div class="col-12 mb-2 mb-md-0">
                                    <input type="tel" class="input form-control @error('telefono') is-invalid @enderror" name="telefono" id="telefono" value="{{ old('telefono') }}" placeholder="Teléfono">
                                    @error('telefono')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="form-group row">
                                <div class="col-12 mb-2 mb-md-0">
                                    <textarea name="descripcion" id="descripcion" class="input form-control @error('descripcion') is-invalid @enderror" placeholder="Escribe una descripción del establecimiento">{{ old('descripcion') }}</textarea>
                                    @error('descripcion')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="form-group row">
                                <div class="col-12 col-md-6 mb-2 mb-md-0">
                                    ...
                                    <input type="time" name="apertura" class="input form-control @error('apertura') is-invalid @enderror" id="apertura" value="{{ old('apertura') }}">
                                    @error('apertura')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-12 col-md-6 mb-2 mb-md-0">
                                    ...
                                    <input type="time" name="cierre" class="input form-control @error('cierre') is-invalid @enderror" id="cierre" value="{{ old('cierre') }}">
                                    @error('cierre')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="form-group row justify-content-center">
                                ...
                                <div class="col-12 col-md-6">
                                    <input type="submit" class="btn btn-block" value="Guardar Datos">
                                </div>
                            </div>
                        </form>
                    </div>
